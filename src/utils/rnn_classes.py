...
class GRUNetv3_LN(nn.Module):
    def __init__(self, input_size, hidden_size,hidden=None,output='raw', dropout=0.3, fc0_size=256,fc1_size=64,num_layers=1):
        ...
        self.rl3 = nn.ReLU()
        self.drop3 = nn.Dropout(dropout)
        self.fc3 = nn.Linear(fc1_size, 20)
        self.hidden_size = hidden_size
...
class GRUNetv3_BN(nn.Module):
    def __init__(self, input_size, hidden_size,hidden=None,output='raw', dropout=0.3, fc0_size=256,fc1_size=64,num_layers=1):
        ...
        # self.layer_norm2 = nn.LayerNorm((hidden_size * 8)+70)
        self.relu0 = nn.ReLU()
        self.fc0 = nn.Linear((hidden_size * 20)+397, (hidden_size * 20)+397)
        # self.drop0 = nn.Dropout(dropout)
        
        self.rl1 = nn.ReLU()
        self.drop1 = nn.Dropout(dropout)
        self.fc1 = nn.Linear((hidden_size * 20)+397, fc0_size)
        self.rl2 = nn.ReLU()
        self.drop2 = nn.Dropout(dropout)
        self.fc2 = nn.Linear(fc0_size, fc1_size)
        self.rl3 = nn.ReLU()
...
class GRUNetv3_BN(nn.Module):
    def __init__(self, input_size, hidden_size,hidden=None,output='raw', dropout=0.3, fc0_size=256,fc1_size=64,num_layers=1):
        ...
        # self.layer_norm2 = nn.LayerNorm((hidden_size * 8)+70)
        self.relu0 = nn.ReLU()
        self.fc0 = nn.Linear((hidden_size * 20)+70, (hidden_size * 8)+70)
        # self.drop0 = nn.Dropout(dropout)
        
        self.rl1 = nn.ReLU()
        self.drop1 = nn.Dropout(dropout)
        self.fc1 = nn.Linear((hidden_size * 20)+70, fc0_size)
        self.rl2 = nn.ReLU()
        self.drop2 = nn.Dropout(dropout)
        self.fc2 = nn.Linear(fc0_size, fc1_size)
        self.rl3 = nn.ReLU()
...
class GRUNetv3_BN_double(nn.Module):
    def __init__(self, input_size, hidden_size,hidden=None,output='raw', dropout=0.3, fc0_size=256,fc1_size=64,num_layers=1):
        ...
        self.price_fc3 = nn.Linear(fc1_size, 20)
